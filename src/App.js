...
*/
  ...
  handleDeleteConfig() {
    if (confirm("Do you want to bye felicia?")) {
      localStorage.setObject('config', null)
  ...
  renderSensors() {
    return (
      <div>
        ...
        <div>
          <Button bsStyle="danger" onClick={() => (this.handleDeleteConfig())}>Bye, Felicia (aka local storage config)</Button>
        </div>
